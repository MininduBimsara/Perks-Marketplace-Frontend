...
export default function PerkDetailPage() {
    ...
    const fetchPerk = async () => {
      ...
      try {
        ...
        if (!isSuccess) {
          ...
          throw new Error(
            `Failed to fetch perk: ${response.status} - ${errorText}`
          );
        }
        ...
        if (isMounted) {
          setError(
            error instanceof Error
              ? error.message
              : "Failed to load perk details. Please try again."
          );
        }
      } finally {
        if (isMounted) {
  ...
  if (error || !perk) {
    console.log("Rendering error state:", {
      error,
      perk: !!perk,
      perkKeys: perk ? Object.keys(perk) : [],
    });
    return (
      <>
        <MetaTags seoData={seoData} />
        <div className="min-h-screen bg-[#f5f1e3]">
          <header className="bg-white shadow-sm">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
              <button
                onClick={handleBack}
                className="flex items-center text-[#1a3d35] hover:text-[#2a4d45] transition"
              >
  ...
  const currency = getCurrency(perk.originalPrice || perk.discountedPrice);
  const hasDiscount = !!(
    originalPriceValue &&
    discountedPriceValue &&
    originalPriceValue > discountedPriceValue
  );
  const tags = parseTags(perk.tags);
  const features = parseFeatures(perk.features);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 rounded-2xl p-8 shadow-sm">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  by {perk.vendor?.name || "Unknown Vendor"}
                </p>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  {perk.shortDescription &&
                    perk.shortDescription !== perk.description && (
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-1">
                      <h3 className="text-lg font-medium text-gray-900 mb-2">
                        {perk.vendor?.name || "Unknown Vendor"}
                      </h3>
                      <p className="text-gray-600 mb-3">
                        {perk.vendor?.description || "No description available"}
                      </p>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-blue-50 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600">
                        {perk.availability.totalQuantity -
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg sticky top-6">
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <p className="text-xs text-gray-500 text-center">
                    By redeeming this offer, you agree to the partner's terms
                    and conditions.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl max-w-md w-full p-8 relative">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  You'll be redirected to {perk.vendor?.name || "the vendor"}'s
                  website to complete your redemption.
                </p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
                    ...
                    {perk.redemption.expiryDate && (
                      <p className="text-sm text-gray-700">
                        ...
                        {formatDate(perk.redemption.expiryDate)}
                      </p>
                    )}
                  </div>
                )}
